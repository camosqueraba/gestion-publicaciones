						...
						<div class="nav-wrapper w100dt">
							...
							<div class="logo left">
								<a href="index.html" class="brand-logo">
									<img src="../resources/img/logo_perfect2.png" alt="brand-logo">
								</a>
							</div>
							<!-- logo -->
							...
							<div>
								...
								<ul id="nav-mobile" class="main-menu center-align hide-on-med-and-down">
									...
									<li><a href="cateogry.html">ANUNCIOS</a></li>
									<li><a href="#">CUMPLEAÑOS </a>	</li>
									<li><a href="single-blog.html">ADMINISTRAR PUBLICACIONES</a></li>
									<li class="dropdown">
								...
								<ul class="side-nav" id="mobile-demo">
									<li class="snavlogo center-align"><img src="../resources/img/logo.png" alt="logo"></li>
				...
				<div class="slider">
					<ul class="slides">
						<li class="slider-item">
							<img src="../resources/img/templatemo_image_01.jpg" alt="Image">
						...
						<li class="slider-item">
							<img src="../resources/img/lifestyle.jpg" alt="Image">
						...
						<li class="slider-item">
							<img src="../resources/img/fashion.jpg" alt="Image">
			...
			<div class="container">
				...
				<div class="owl-carousel small-carousel owl-theme">
					<div class="item">
						<div class="card horizontal">
							<div class="card-image">
								<img src="../resources/img/img1.jpg" alt="Image">
					...
					<div class="item">
						<div class="card horizontal">
							<div class="card-image">
								<img src="../resources/img/img2.jpg" alt="Image">
								<span class="effect"></span>
							</div>
							<!-- /.card-image -->
							<div class="card-stacked">
					...
					<div class="item">
						<div class="card horizontal">
							<div class="card-image">
								<img src="../resources/img/img3.jpg" alt="Image">
								<span class="effect"></span>
							</div>
							<!-- /.card-image -->
							<div class="card-stacked">
				...
				<div class="row">
					...
					<div class="col s12 m8 l8">
						...
						<div class="blogs mb-30">
							<div class="card">
								<div class="card-image">
									<img src="../resources/img/selfie.jpg" alt="Image">
						...
						<div class="blogs mb-30">
							<div class="card">
								<div class="card-image">
									<img src="../resources/img/blog4.jpg" alt="Image">
									<a class="btn-floating center-align cmn-bgcolor halfway-fab waves-effect waves-light">
										<i class="icofont icofont-camera-alt"></i>
									</a>
								</div>
						...
						<div class="blogs mb-30">
							<div class="card">
								<div class="card-image">
									<img src="../resources/img/travel2.jpg" alt="Image">
									<a class="btn-floating center-align cmn-bgcolor halfway-fab waves-effect waves-light">
										<i class="icofont icofont-camera-alt"></i>
									</a>
								</div>
						...
						<div class="blogs mb-30">
							<div class="card">
								<div class="card-image">
									<img src="../resources/img/fashion2.jpg" alt="Image">
									<a class="btn-floating center-align cmn-bgcolor halfway-fab waves-effect waves-light">
										<i class="icofont icofont-camera-alt"></i>
									</a>
								</div>
							...
							<div class="sidebar-posts">
								<div class="card">
									<div class="card-image mb-10">
										<img src="../resources/img/blog3.jpg" alt="Image">
										<span class="effect"></span>
									</div>
									<!-- /.card-image -->
									<div class="card-content w100dt">
								...
								<div class="card">
									<div class="card-image mb-10">
										<img src="../resources/img/blog1.jpg" alt="Image">
										<span class="effect"></span>
									</div>
									<!-- /.card-image -->
									<div class="card-content w100dt">
								...
								<div class="card">
									<div class="card-image mb-10">
										<img src="../resources/img/blog2.jpg" alt="Image">
										<span class="effect"></span>
									</div>
									<!-- /.card-image -->
									<div class="card-content w100dt">
							...
							<div id="test-swipe-3" class="tab-contant Comments-post">
								...
								<div class="card-panel grey lighten-5 z-depth-1">
									<div class="row valign-wrapper">
										<div class="col s3">
											<img src="../resources/img/img1.png" alt="Image" class="circle responsive-img"> <!-- notice the "circle" class -->
										</div>
										<div class="col s9">
								...
								<div class="card-panel grey lighten-5 z-depth-1">
									<div class="row valign-wrapper">
										<div class="col s3">
											<img src="../resources/img/img2.png" alt="Image" class="circle responsive-img"> <!-- notice the "circle" class -->
										</div>
										<div class="col s9">
											<span class="black-text">
												Lorem ipsum dolor sit amet, consectetur adipisicing elit.
								...
								<div class="card-panel grey lighten-5 z-depth-1">
									<div class="row valign-wrapper">
										<div class="col s3">
											<img src="../resources/img/img3.png" alt="Image" class="circle responsive-img"> <!-- notice the "circle" class -->
										</div>
										<div class="col s9">
											<span class="black-text">
												Lorem ipsum dolor sit amet, consectetur adipisicing elit.
			...
			<div class="container">
				...
				<div class="footer-logo w100dt center-align mb-30">
					<a href="#" class="brand-logo">
						<img src="../resources/img/logo.png" alt="brand-logo">
					</a>
				</div>
				<!-- /.footer-logo -->
